...
Node* findMax(DoublyLinkedList l, bool func(int, int)) {
	if (l.head == nullptr)
		return nullptr;
	Node* res = l.head;
	Node* q = l.head->next;
...
//Them phan tu x vao phia sau phan tu key
...
int main() {
	...
	cout << "=========================TIM KIEM=======================\n";
	cout << "Ket qua: " << search(l, 1)->info << endl;
	cout << "Max: " << findMax(l, max)->info << endl;
	cout << "Min: " << findMax(l, min)->info << endl;
